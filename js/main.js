        ...
        <a href="pages/detail.html?id=${s.id}" style="text-decoration:none; color:inherit;">
          <div class="sketch-card">
            <div class="sketch-img">
              <img src="${s.image ? 'images/sketches/' + s.image : 'https://picsum.photos/400/300?grayscale'}" alt="${s.title}"/>
            </div>
  ...
  fetch('../php/get-sketch.php?id=' + id)
    ...
    .then(sketch => {
      ...
      if (allImages.length === 0) {
        galleryContainer.innerHTML = '<img src="https://picsum.photos/600/500?grayscale" alt="No image" style="width:100%; border-radius:12px;"/>';
        return;
      }
