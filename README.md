...
📂 Project Structure
```markdown
# 🎨 Romee Sketch Art — Vulnerable by Design

> *"A pencil sketch website that looks legit, works perfectly, and breaks exactly where I want it to."*

---

## ⚡ Quick Overview

Built this from scratch for my cybersecurity assignment — a fully functional e-commerce platform for hand-drawn pencil sketches with **30+ intentionally planted vulnerabilities** across the OWASP Top 10.

**Live Demo:** [romeesketchart.infinityfreeapp.com](http://romeesketchart.infinityfreeapp.com)
...
```bash
# Clone
git clone https://github.com/amromankhan/romee-sketch-art.git
...
├── css/style.css              # Dark theme (Instagram vibes)
├── js/main.js                 # 700 lines of spaghetti (intentionally)
├── pages/
...
> *"If you can't hack my website, I didn't do my job right."* 🔓
